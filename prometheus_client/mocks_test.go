...
// Package promclient is a generated GoMock package.... almost, I had to change the package name
package promclient
...
func (m *MockAPI) LabelNames(arg0 context.Context) ([]string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) LabelValues(arg0 context.Context, arg1 string) (model.LabelValues, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Query(arg0 context.Context, arg1 string, arg2 time.Time) (model.Value, api.Warnings, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) QueryRange(arg0 context.Context, arg1 string, arg2 v1.Range) (model.Value, api.Warnings, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Series(arg0 context.Context, arg1 []string, arg2, arg3 time.Time) ([]model.LabelSet, api.Warnings, error) {
	m.ctrl.T.Helper()
