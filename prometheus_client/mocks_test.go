...
func (m *MockAPI) Query(arg0 context.Context, arg1 string, arg2 time.Time) (model.Value, error) {
...
func (m *MockAPI) QueryRange(arg0 context.Context, arg1 string, arg2 v1.Range) (model.Value, error) {
...
func (m *MockAPI) Series(arg0 context.Context, arg1 []string, arg2, arg3 time.Time) ([]model.LabelSet, error) {
